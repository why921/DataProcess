...
labeltxt = open(path+'\\'+sar+'\\'+sar+'_SLC_24.txt', 'w')
...
for i in range(0, len(GCPdata)):
    ...
    labelid=label[i]
    write_img(path+'\\'+sar+'\\'+sar+'_SLC_24\\'+sar+'_SLC_'+'HH_' + str(i) + date + str(labelid)+'.tif', 2 * RECT_SIZE, 2 * RECT_SIZE,
              1, band1.DataType, nnpp1)
    labeltxt.write(path+'\\'+sar+'\\'+sar+'_SLC_24\\'+sar+'_SLC_'+'HH_' + str(i) + date + str(labelid)+'.tif' + ' ' + str(labelid)+'\n')
    write_img(path+'\\'+sar+'\\'+sar+'_SLC_24\\'+sar+'_SLC_'+'HV_' + str(i) + date + str(labelid)+'.tif', 2 * RECT_SIZE, 2 * RECT_SIZE,
              1, band1.DataType, nnpp2)
    labeltxt.write(path+'\\'+sar+'\\'+sar+'_SLC_24\\'+sar+'_SLC_'+'HV_' + str(i) + date + str(labelid)+'.tif' + ' ' + str(labelid)+'\n')
    write_img(path+'\\'+sar+'\\'+sar+'_SLC_24\\'+sar+'_SLC_'+'VH_' + str(i) + date + str(labelid) + '.tif', 2 * RECT_SIZE, 2 * RECT_SIZE,
              1, band1.DataType, nnpp3)
    labeltxt.write(path+'\\'+sar+'\\'+sar+'_SLC_24\\'+sar+'_SLC_'+'VH_' + str(i) + date + str(labelid) + '.tif' + ' ' + str(labelid) + '\n')
    write_img(path+'\\'+sar+'\\'+sar+'_SLC_24\\'+sar+'_SLC_'+'VV_' + str(i) + date + str(labelid) + '.tif', 2 * RECT_SIZE, 2 * RECT_SIZE,
              1, band1.DataType, nnpp4)
    labeltxt.write(path+'\\'+sar+'\\'+sar+'_SLC_24\\'+sar+'_SLC_'+'VV_' + str(i) + date + str(labelid) + '.tif' + ' ' + str(labelid) + '\n')
